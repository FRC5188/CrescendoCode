...
public class CmdShooterRunShooter extends Command {
    ...
    public CmdShooterRunShooter(Shooter shooterSubsystem, Intake intakeSubsystem) {
        _shooterSubsystem = shooterSubsystem;
        _intakeSubsystem = intakeSubsystem;
        addRequirements(_shooterSubsystem, _intakeSubsystem);
    }
    ...
    public void initialize() {
        if (_intakeSubsystem.hasNote()) {
            _zone = _shooterSubsystem.getCurrentZone();
