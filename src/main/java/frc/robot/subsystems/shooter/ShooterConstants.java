...
public abstract class ShooterConstants {
    ...
    // unknown
    public static final LoggedTunableNumber ZONE_UNKNOWN_FLYWHEEL_SPEED = new LoggedTunableNumber("Shooter/UNKNOWN_FLYWHEEL_SPEED", 1200); //1200
    ...
    public static final double SHOOTER_FEEDFORWARD_CONSTANT = 
        ...
        / (NEO_VORTEX_TORQUE_CONSTANT * ANGLE_GEAR_RATIO)) - 0.08;
