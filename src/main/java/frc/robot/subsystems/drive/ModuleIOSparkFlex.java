  ...
  public ModuleIOSparkFlex(int index) {
    switch (index) {
      case 0: //Front Left
        ...
        _absoluteEncoderOffset = Rotation2d.fromRotations(0.0588); // MUST BE CALIBRATED
        break;
      case 1: //Front Right
        ...
        _absoluteEncoderOffset = Rotation2d.fromRotations(0.211); // MUST BE CALIBRATED
        break;
      case 2: //Back Left
        ...
        _absoluteEncoderOffset = Rotation2d.fromRotations(-0.2687); // MUST BE CALIBRATED
        break;
      case 3: //Back Right
        ...
        _absoluteEncoderOffset = Rotation2d.fromRotations(0.1160); // MUST BE CALIBRATED
        break;
      default:
