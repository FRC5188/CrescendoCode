...
public class CmdGoToNoteWithSideTranslation extends Command {
  private final Drive _drive;
  private final VisionDrive _visionDrive;
  private final Intake _intake;
  private ChassisSpeeds _chassisSpeeds;

  public CmdGoToNoteWithSideTranslation(Drive drivetrainSubsystem, VisionDrive visionDriveSubsystem, Intake intakeSubsystem) {
