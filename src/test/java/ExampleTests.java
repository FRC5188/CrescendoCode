...
//         _hardware = new SimHardware();
//         _subsystem = new Subsystem(_hardware);

//         // If you need to do method mocking, make the subsystem like this
//         _subsystem = EasyMock.partialMockBuilder(Subsystem.class)
//                 .addMockedMethod("foo3")
//                 .mock();
//     }
